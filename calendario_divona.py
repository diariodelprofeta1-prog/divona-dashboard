...
def generar_dashboard():
    ...
    ocupacion = {} 
    # Paleta de colores distintos para que no se mezclen clientes
    ...
    for r in res.json().get("results", []):
        ...
        # ASIGNAR COLOR ÚNICO POR RESERVA (usando el ID de Notion)
        res_id = r["id"]
    ...
    html += '.day { aspect-ratio: 1/1; display: flex; align-items: center; justify-content: center; font-size: 0.7rem; border-radius: 2px; } '
    # Importante: He quitado el color azul de aquí abajo para que mande el color del cliente
    html += '.occupied { color: white; font-weight: 900; cursor: pointer; border: 1px solid rgba(0,0,0,0.2); } '
    ...
    for mes in range(3, 12):
        ...
        for dia in range(1, ultimo + 1):
            ...
            if res:
                # Aquí es donde ocurre la magia: cada día tiene el color de SU cliente
